...
class Header extends Component {
  ...
  render() {
    ...
    let logoUrl;
    if (logo === "light") {
      logoUrl = <img src={logoLight} alt="Social Media Panamá Digital Agency" />;
    } else if (logo === "dark") {
      logoUrl = <img src={logoDark} alt="Social Media Panamá Digital Agency" />;
    } else if (logo === "symbol-dark") {
      logoUrl = <img src={logoSymbolDark} alt=" Social Media Panamá  Digital Agency" />;
    } else if (logo === "symbol-light") {
      logoUrl = <img src={logoSymbolLight} alt="Social Media Panamá  Digital Agency" />;
    } else {
      logoUrl = <img src={logoDefault} alt="Social Media Panamá  Digital Agency" />;
    }
